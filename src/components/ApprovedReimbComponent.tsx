...
import {approvedReimb, getReimbByReimbID} from '../remote/reimb-service';
...
const ApprovedReimbComponent = (props: IReimbProp) =>{
	...
	useEffect(()=>{
		let fetchData = async() =>{
			const response = await approvedReimb();
...
export default ApprovedReimbComponent;
