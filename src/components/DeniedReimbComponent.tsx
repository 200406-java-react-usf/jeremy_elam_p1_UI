...
import {deniedReimb, getReimbByReimbID} from '../remote/reimb-service';
...
const DeniedReimbComponent = (props: IReimbProp) =>{
	...
	useEffect(()=>{
		let fetchData = async() =>{
			const response = await deniedReimb();
...
export default DeniedReimbComponent;
